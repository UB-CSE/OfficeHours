...
class EnterQueueListener(server: OfficeHoursServer) extends DataListener[String] {
  override def onData(socket: SocketIOClient, payload: String, ackRequest: AckRequest): Unit = {
    val things = payload.split("᳄")
    val username = things.head
    val description = things.last
